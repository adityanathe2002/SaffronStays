...
const AllFarmHouses = () => {
    let { filteredFarmhouse, theme, addBookmark, setAddBookmark } = useContext(staysContext);
    const [currentImageIndex, setCurrentImageIndex] = useState(0);
    const [stayType, setStayType] = useState("farmhouses");
    ...
    const currentTents = filteredFarmhouse.slice(indexOfFirstTents, indexOfLastTents);
    ...
    return (
        <Box>
            ...
            <Box
                ...
                <Pagination
                    count={Math.ceil(filteredFarmhouse.length / TentsPerPage)}
                    page={page}
